...
<body>
	<form action="doc_DoctorAddServlet" method="post">
		<h2>注册</h2>
		<label for="username">医生账号</label>
		<input type="text" id="username" name="did" required placeholder="输入您的账号，需要为纯数字">
		
		<label for="password">密码</label>
		<input type="password" id="password1" name="dpass" required placeholder="输入您的密码">
		...
		<input type="text" id="username" name="djob" required placeholder="选择您的职位：1：医生，2：护士">
		
		<button type="submit" >注册</button>
		<div class="register">
			已经注册过了？ <a href="doctor_login.jsp">点击登录</a>
		</div>
	</form>
</body>
</html>
