<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%>
    <%@ page import="adm_com.model.Medicine" %>
...
<head>
    ...
    <script>
        //添加
        function submit1() {
            document.form1.action = "adm_MedicineAddServlet"
            document.form1.submit();
        }
        //修改
        function submit2() {
            document.form1.action = "adm_MedicineFixServlet"
            document.form1.submit();
        }
        //删除
        function submit3() {
            document.form1.action = "adm_MedicineDelServlet"
            document.form1.submit();
        }
        //查询
        function submit4() {
            document.form1.action = "adm_MedicineQueServlet"
            document.form1.submit();
        }
    </script>
</head>
                ...
                <div class="col-md-12 column">
                    <table class="table">
                        ...
                        <tbody>
                            <% ArrayList usermess=(ArrayList) session.getAttribute("usermessage");
                                ...
                                i=0;i<usermess.size();i++){ Medicine a=(Medicine)usermess.get(i); %>
                    ...
                    <form class="form-horizontal" role="form" name="form1" method="post">
                        <div class="form-group">
                            <label for="inputEmail31" class="col-sm-2 control-label">药品id</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputEmail31" name="mid" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputEmail33" class="col-sm-2 control-label">药品名</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputEmail33" name="mname" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputEmail34" class="col-sm-2 control-label">药品价格</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputEmail34" name="mprice" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputEmail35" class="col-sm-2 control-label">药品库存</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputEmail35" name="mnum" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputEmail36" class="col-sm-2 control-label">药品有效期</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputEmail36" name="mdate" />
                            </div>
                        </div>
