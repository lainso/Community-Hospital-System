...
/**
 * Servlet implementation class adm_MedicineAddServlet
 */
@WebServlet("/adm_MedicineAddServlet")
public class adm_MedicineAddServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public adm_MedicineAddServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean a = medicineDao.add(mid,mname,mprice,mnum,mdate);
