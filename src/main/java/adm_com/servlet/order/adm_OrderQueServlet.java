...
import adm_com.model.Order;

/**
 * Servlet implementation class adm_OrderQueServlet
 */
@WebServlet("/adm_OrderQueServlet")
public class adm_OrderQueServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public adm_OrderQueServlet() {
        super();
