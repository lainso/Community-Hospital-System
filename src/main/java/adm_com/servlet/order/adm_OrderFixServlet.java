...
/**
 * Servlet implementation class adm_OrderFixServlet
 */
@WebServlet("/adm_OrderFixServlet")
public class adm_OrderFixServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public adm_OrderFixServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean sta = OrderDao.fix(otime, did, uid, oresult, omedicine, omoney, oid);
		if(sta==true){
