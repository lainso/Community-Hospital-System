...
/**
 * Servlet implementation class use_UserChaServlet
 */
@WebServlet("/use_UserChaServlet")
public class use_UserChaServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public use_UserChaServlet() {
        super();
